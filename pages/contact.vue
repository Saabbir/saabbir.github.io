  ...
  <div class="u-py-32">
    <div class="l-wrap">
      <div class="c-copy u-mx-auto">
        <h1 class="t-display-1 u-mb-64 u-text-center">Get in touch</h1>
        <p>
          If you want to get in touch, send me an email at
          <a href="mailto:thesaabbir@gmail.com" class="c-custom-link"
            >thesaabbir@gmail.com</a
          >
          or call me at
          <a href="tel:+8801789243439" class="c-custom-link">+8801789243439</a>.
        </p>
        <p>
          ...
          >
            <div class="c-social-media__icon">
              <div
                ...
                v-html="
                  require('~/assets/images/svg/stackoverflow.svg?include')
                "
              ></div>
            </div>
            <div class="c-social-media__info">
      ...
      <div class="c-contact-form-container u-mt-32 u-mx-auto">
        <h2 class="c-contact-form__title u-text-serif u-mb-48 u-text-center">
          Send a message
        </h2>
        <form
