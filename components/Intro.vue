<template>
  <div class="c-intro-wrapper">
    <div class="l-wrap">
      <div class="c-intro c-intro--v1 u-d-none">
      ...
      <img src="~/assets/images/profile-pic.jpeg" alt="Saabbir Hossain's Profile Picture">
        ...
        <div class="c-intro__content">
          ...
          <p>
            ...
            <strong>A/B testing expert</strong> based in Barisal, Bangladesh,
            currently working as a <strong>Sr. Software Engineer</strong> at
            EchoLogyx Ltd.
          </p>
          ...
          <div class="c-buttons u-mt-32 u-mt-sm-48">
            ...
            <nuxt-link to="/contact" class="c-button c-button--lg"
      ...
      <div class="c-intro c-intro--v2 u-d-block">
        <div class="c-intro__content u-text-center u-mx-auto">
          <h1 class="t-display-1 u-mb-24">Hi, I'm Saabbir.</h1>
          <p>
            A front-end web developer and
            <strong>A/B testing expert</strong> based in Barisal, Bangladesh,
